class BusesController < ApplicationController
  ...
  private
    ...
    def bus_params
      params.require(:bus).permit(:link_route, :bus_code, :route, :arrival_1, :arrival_2, :undertaking_unit, :phone, :type_of_operation, :distance, :range_of_bus, :uptime, :fare, :quantity_trip, :trip_time, :trip_spacing)
    end
end
